...
__global__ void executeTests(const TestCase* __restrict__ testCases, 
    ...
    switch (tc.opcode) {
        ...
        case UNORDERED:
            ...
            break;
	case CMPEQTRUE:
            res = (a == c) ? __nv_bfloat16(__nv_bfloat16_raw{0x4000}) : __nv_bfloat16(__nv_bfloat16_raw{0x0000});
            break;
        case CMPLTTRUE:
            res = (a < c) ? __nv_bfloat16(__nv_bfloat16_raw{0x4000}) : __nv_bfloat16(__nv_bfloat16_raw{0x0000});
            break;
        ...
        case UNORDEREDTRUE:
            res = (__hisnan(a) || __hisnan(c))
		  ? __nv_bfloat16(__nv_bfloat16_raw{0x4000})
		  : __nv_bfloat16(__nv_bfloat16_raw{0x0000});
            break;
        case TSEL:
            res = (b != __nv_bfloat16(__nv_bfloat16_raw{0x0000})) ? c : a;
            break;
    }
