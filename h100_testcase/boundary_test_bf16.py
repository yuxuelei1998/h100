...
def generate_bf16_boundary_test_cases():
    """生成BF16边界测试用例三元组"""
    test_cases = []
    for a in hex_values:
        for b in hex_values:
...
def save_bf16_boundary_test_cases(test_cases, filename="bf16_boundary_test_cases.txt"):
    """保存BF16边界测试激励到文件"""
    ...
    print(f"BF16边界值数量: {unique_values}")
...
# 生成并保存测试激励
bf16_boundary_test_cases = generate_bf16_boundary_test_cases()
save_bf16_boundary_test_cases(bf16_boundary_test_cases)